...
data = read.table(paste(workpath, 'temp/N30_1000000', sep = ''))
n7 = data$V2
n30 = data$V3
lines(n7, n30, type = 'p', pch = 20, col = 'blue')

data = read.table(paste(workpath, 'temp/N30_0000000', sep = ''))
n7 = data$V2
n30 = data$V3
lines(n7, n30, type = 'p', pch = 20, col = 'red')

data = read.table(paste(workpath, 'temp/N30_1100000', sep = ''))
n7 = data$V2
n30 = data$V3
lines(n7, n30, type = 'p', pch = 20, col = 'green')

data = read.table(paste(workpath, 'temp/N30_0100000', sep = ''))
n7 = data$V2
n30 = data$V3
lines(n7, n30, type = 'p', pch = 20, col = 'orange')

data = read.table(paste(workpath, 'temp/N30_1001000', sep = ''))
n7 = data$V2
n30 = data$V3
lines(n7, n30, type = 'p', pch = 1, col = 'purple')

data = read.table(paste(workpath, 'temp/N30_0001000', sep = ''))
n7 = data$V2
n30 = data$V3
